                    ...
                    <form action="<?php echo e(route('dashboard.products.update',$product->id)); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <?php $__currentLoopData = config('translatable.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="<?php echo e($locale); ?>[name]" class="form-control" value="<?php echo e($product->translate($locale)->name); ?>">
                            </div>

                            <div class="form-group">
                                <label><?php echo app('translator')->get('site.' . $locale . '.description'); ?></label>
                                <textarea name="<?php echo e($locale); ?>[description]" class="form-control ckeditor"><?php echo e($product->translate($locale)->description); ?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image" class="form-control image" value=<?php echo e($product->image); ?>>
                        </div>

                        <div class="form-group">
                            <img src="<?php echo e(asset('uploads/product_images/'.$product->image)); ?>" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>

                        <div class="form-group">
                            <label><?php echo app('translator')->get('site.purchase_price'); ?></label>
                            <input type="number" name="purchase_price" step="0.01" class="form-control" value="<?php echo e($product->purchase_price); ?>">
                        </div>

                        <div class="form-group">
                            <label><?php echo app('translator')->get('site.sale_price'); ?></label>
                            <input type="number" name="sale_price" step="0.01" class="form-control" value="<?php echo e($product->sale_price); ?>">
                        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\pos-master\resources\views/dashboard/products/edit.blade.php ENDPATH**/ ?>