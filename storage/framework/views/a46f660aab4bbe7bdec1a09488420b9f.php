                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo e(route('dashboard.categories.update', $category->id)); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ar[name]" class="form-control" value="<?php echo e($category->name); ?>">
                        </div>

                        <div class="form-group">
                            <label><?php echo app('translator')->get('site.en.name'); ?></label>
                            <input type="text" name="en[name]" class="form-control" value="<?php echo e($category->translate('en')->name); ?>">
                        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\pos\resources\views/dashboard/categories/edit.blade.php ENDPATH**/ ?>