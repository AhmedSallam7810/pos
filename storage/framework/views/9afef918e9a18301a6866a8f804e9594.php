            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo e(route('dashboard.users.store')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img src="<?php echo e(asset('uploads/user_images/default.png')); ?>"  style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\pos-master\resources\views/dashboard/users/create.blade.php ENDPATH**/ ?>